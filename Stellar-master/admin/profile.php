    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center">
          ...
          <a class="navbar-brand brand-logo-mini" href="index2.php"><img src="../images/logo-mini.svg" alt="logo" /></a>
        </div>
             ...
             <h1>Personal Information</h1> 
              <?php 
               ...
               try{ 
                 ...
                 $stmt=$db->prepare('SELECT * FROM cms_users WHERE username = :username');
                 ...
                 while($row = $stmt->fetch()){
                  ...
                  echo'<p> number of task completed';
                  echo'<p>task assigned:  due date : </p>';
                  echo '<a href=""> assign new task</a>';
